...
namespace M3.Cord.Models
{
    public class S4_1ConditionStd
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static NDbResult<List<S4_1ConditionStd>> Gets()
        {
            MethodBase med = MethodBase.GetCurrentMethod();

            NDbResult<List<S4_1ConditionStd>> rets = new NDbResult<List<S4_1ConditionStd>>();
            ...
            try
            {
                var items = cnn.Query<S4_1ConditionStd>("GetS4_1ConditionStd", p,
            ...
            {
                // create empty list.
                rets.data = new List<S4_1ConditionStd>();
            }
        ...
        /// Save
        /// </summary>
        /// <param name="value">The S4_1ConditionStd item to save.</param>
        /// <returns></returns>
        public static NDbResult<S4_1ConditionStd> Save(S4_1ConditionStd value)
        {
            MethodBase med = MethodBase.GetCurrentMethod();

            NDbResult<S4_1ConditionStd> ret = new NDbResult<S4_1ConditionStd>();
            ...
            try
            {
                cnn.Execute("SaveS4_1ConditionStd", p, commandType: CommandType.StoredProcedure);
                ret.Success(value);
        ...
        public static NDbResult Delete(S4_1ConditionStd value)
        {
            MethodBase med = MethodBase.GetCurrentMethod();
            ...
            try
            {
                cnn.Execute("DELETE FROM S4_1ConditionStd WHERE ProductCode = @ProductCode", p, commandType: CommandType.Text);
                ret.Success();
                // Set error number/message
                ret.ErrNum = p.Get<int>("@errNum");
                ret.ErrMsg = p.Get<string>("@errMsg");
