...
{
    public class S8x2BeforeCondition
    {
        #region Public Proeprties

        public int? S8x2BeforeId { get; set; }
        ...
        public bool ShowVerify
        {
            get
            {
                return (RowType == 1 && S8x2BeforeId.HasValue && S8x2BeforeId.Value > 0);
            }
            set { }
        }
        ...
        public static S8x2BeforeCondition Create(string productCode)
        {
            var inst = new S8x2BeforeCondition();
            var std = S8x2BeforeConditionStd.Gets(productCode).Value().FirstOrDefault();
            Assign(std, inst);
            return inst;
        }

        public static void Assign(S8x2BeforeConditionStd src, S8x2BeforeCondition dst)
        {
        ...
        public static NDbResult<List<S8x2BeforeCondition>> Gets(int? DIPPCId)
        {
            MethodBase med = MethodBase.GetCurrentMethod();

            NDbResult<List<S8x2BeforeCondition>> ret = new NDbResult<List<S8x2BeforeCondition>>();
            ...
            try
            {
                var items = cnn.Query<S8x2BeforeCondition>("GetS8x2BeforeConditions", p,
            ...
            catch (Exception ex)
            {
                ...
                ret.data = new List<S8x2BeforeCondition>();
            }
        ...
        /// <returns></returns>
        public static NDbResult<S8x2BeforeCondition> Save(S8x2BeforeCondition value)
        {
            MethodBase med = MethodBase.GetCurrentMethod();

            NDbResult<S8x2BeforeCondition> ret = new NDbResult<S8x2BeforeCondition>();
            ...
            p.Add("@S8x2BeforeId", value.S8x2BeforeId, DbType.Int32, direction: ParameterDirection.InputOutput);
            ...
            try
            {
                cnn.Execute("SaveS8x2BeforeCondition", p, commandType: CommandType.StoredProcedure);
                ret.Success(value);

                // Set PK
                value.S8x2BeforeId = p.Get<dynamic>("@S8x2BeforeId");
                // Set error number/message
        ...
        public static NDbResult<S8x2BeforeCondition> GetStdV(int? DIPPCId)
        {
            MethodBase med = MethodBase.GetCurrentMethod();
            ...
            try
            {
                var items = cnn.Query<S8x2BeforeCondition>("GetS8x2BeforeStdVRow", p,
                    commandType: CommandType.StoredProcedure);
        ...
        public static NDbResult<S8x2BeforeCondition> GetStdB(int? DIPPCId)
        {
            MethodBase med = MethodBase.GetCurrentMethod();
            ...
            try
            {
                var items = cnn.Query<S8x2BeforeCondition>("GetS8x2BeforeStdBRow", p,
                    commandType: CommandType.StoredProcedure);
                var data = (null != items) ? items.FirstOrDefault() : null;
                ret.Success(data);
            }
        ...
        public static NDbResult<S8x2BeforeCondition> GetStdCF(int? DIPPCId)
        {
            MethodBase med = MethodBase.GetCurrentMethod();
            ...
            try
            {
                var items = cnn.Query<S8x2BeforeCondition>("GetS8x2BeforeStdCFRow", p,
                    commandType: CommandType.StoredProcedure);
                var data = (null != items) ? items.FirstOrDefault() : null;
                ret.Success(data);
            }
        ...
        public static NDbResult SaveStdV(int? DIPPCId, string ProductCode, string LotNo)
        {
            ...
            try
            {
                var items = cnn.Query<S8x2BeforeCondition>("SaveS8x2BeforeStdVRow", p,
                    commandType: CommandType.StoredProcedure);
                ret.Success();
            }
            catch (Exception ex)
        ...
        public static NDbResult SaveStdB(int? DIPPCId, string ProductCode, string LotNo)
        {
            ...
            try
            {
                var items = cnn.Query<S8x2BeforeCondition>("SaveS8x2BeforeStdBRow", p,
                    commandType: CommandType.StoredProcedure);
                ret.Success();
            }
            catch (Exception ex)
        ...
        public static NDbResult SaveStdCF(int? DIPPCId, string ProductCode, string LotNo)
        {
            ...
            try
            {
                var items = cnn.Query<S8x2BeforeCondition>("SaveS8x2BeforeStdCFRow", p,
                    commandType: CommandType.StoredProcedure);
                ret.Success();
            }
            catch (Exception ex)
        ...
        public static NDbResult DeleteStd(int? DIPPCId)
        {
            ...
            try
            {
                var items = cnn.Query<S8x2BeforeCondition>("DeleteS8x2BeforeStd", p,
                    commandType: CommandType.StoredProcedure);
                ret.Success();
            }
            catch (Exception ex)
