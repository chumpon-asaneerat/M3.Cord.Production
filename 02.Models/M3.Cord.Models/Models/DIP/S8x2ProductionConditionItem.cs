...
{
    public class S8x2ProductionConditionItem
    {
        ...
        public string StretchDValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (StretchD.HasValue) ? StretchD.Value.ToString("#,##0.0#") : "";
                    fmt += " ± ";
                    fmt += (StretchDErr.HasValue) ? StretchDErr.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (StretchDValue.HasValue) ? StretchDValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (StretchDValue.HasValue) ? StretchDValue.Value.ToString("#,##0.0#") : "";
        ...
        public string StretchHValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (StretchH.HasValue) ? StretchH.Value.ToString("#,##0.0#") : "";
                    fmt += " ± ";
                    fmt += (StretchHErr.HasValue) ? StretchHErr.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (StretchHValue.HasValue) ? StretchHValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (StretchHValue.HasValue) ? StretchHValue.Value.ToString("#,##0.0#") : "";
        ...
        public string StretchNValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (StretchN.HasValue) ? StretchN.Value.ToString("#,##0.0#") : "";
                    fmt += " ± ";
                    fmt += (StretchNErr.HasValue) ? StretchNErr.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (StretchNValue.HasValue) ? StretchNValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (StretchNValue.HasValue) ? StretchNValue.Value.ToString("#,##0.0#") : "";
        ...
        public string TempDValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (TempD.HasValue) ? TempD.Value.ToString("#,##0.0#") : "";
                    fmt += " ± ";
                    fmt += (TempDErr.HasValue) ? TempDErr.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (TempDValue.HasValue) ? TempDValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (TempDValue.HasValue) ? TempDValue.Value.ToString("#,##0.0#") : "";
        ...
        public string TempHNValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (TempHN.HasValue) ? TempHN.Value.ToString("#,##0.0#") : "";
                    fmt += " ± ";
                    fmt += (TempHNErr.HasValue) ? TempHNErr.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (TempHNValue.HasValue) ? TempHNValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (TempHNValue.HasValue) ? TempHNValue.Value.ToString("#,##0.0#") : "";
        ...
        public string SpeedValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (Speed.HasValue) ? Speed.Value.ToString("#,##0.0#") : "";
                    fmt += " ± ";
                    fmt += (SpeedErr.HasValue) ? SpeedErr.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (SpeedValue.HasValue) ? SpeedValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (SpeedValue.HasValue) ? SpeedValue.Value.ToString("#,##0.0#") : "";
        ...
        public string TreatValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (Treat.HasValue) ? Treat.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (TreatValue.HasValue) ? TreatValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (TreatValue.HasValue) ? TreatValue.Value.ToString("#,##0.0#") : "";
        ...
        public string DoffingLengthValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (DoffingLength.HasValue) ? DoffingLength.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (DoffingLengthValue.HasValue) ? DoffingLengthValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (DoffingLengthValue.HasValue) ? DoffingLengthValue.Value.ToString("#,##0.0#") : "";
        ...
        public string WeightValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (Weight.HasValue) ? Weight.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (WeightValue.HasValue) ? WeightValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (WeightValue.HasValue) ? WeightValue.Value.ToString("#,##0.0#") : "";
        ...
        public string SpindleValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (Spindle.HasValue) ? Spindle.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (SpindleValue.HasValue) ? SpindleValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (SpindleValue.HasValue) ? SpindleValue.Value.ToString("#,##0.0#") : "";
        ...
        public string ProductionGoodValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (ProductionGood.HasValue) ? ProductionGood.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (ProductionGoodValue.HasValue) ? ProductionGoodValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (ProductionGoodValue.HasValue) ? ProductionGoodValue.Value.ToString("#,##0.0#") : "";
        ...
        public string ProductionTotalValueS
        {
            get
            {
                ...
                {
                    string fmt = string.Empty;
                    fmt += (ProductionTotal.HasValue) ? ProductionTotal.Value.ToString("#,##0.0#") : "";
                    return fmt;
                }
                else if (RowType == -1)
                {
                ...
                {
                    return (ProductionTotalValue.HasValue) ? ProductionTotalValue.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (ProductionTotalValue.HasValue) ? ProductionTotalValue.Value.ToString("#,##0.0#") : "";
        ...
        public string ProductionCutValueS
        {
            get
            {
                ...
                {
                    return (ProductionCut.HasValue) ? ProductionCut.Value.ToString("#,##0.0#") : "";
                }
                else
                {
                    return (ProductionCut.HasValue) ? ProductionCut.Value.ToString("#,##0.0#") : "";
        ...
        public string PositionCordCutCreelValueS
        {
            get
            {
                ...
                {
                    return string.Format("{0:#,###} CH, {1:#,##0.0#} KG", PositionCordCutCreel, PositionCordCutCreelKG);
                }
                else
                {
                    return string.Format("{0:#,###} CH, {1:#,##0.0#} KG", PositionCordCutCreel, PositionCordCutCreelKG);
        ...
        public string PositionCordCutCSValueS
        {
            get
            {
                ...
                {
                    return string.Format("{0:#,###} CH, {1:#,##0.0#} KG", PositionCordCutCS, PositionCordCutCSKG);
                }
                else
                {
                    return string.Format("{0:#,###} CH, {1:#,##0.0#} KG", PositionCordCutCS, PositionCordCutCSKG);
        ...
        public string PositionCordCutWinderValueS
        {
            get
            {
                ...
                {
                    return string.Format("{0:#,###} CH, {1:#,##0.0#} KG", PositionCordCutWinder, PositionCordCutWinderKG);
                }
                else
                {
                    return string.Format("{0:#,###} CH, {1:#,##0.0#} KG", PositionCordCutWinder, PositionCordCutWinderKG);
        ...
        public string PositionCordCutWasteYarnValueS
        {
            get
            {
                ...
                {
                    return string.Format("{0:#,###} CH, {1:#,##0.0#} KG", PositionCordCutWasteYarn, PositionCordCutWasteYarnKG);
                }
                else
                {
                    return string.Format("{0:#,###} CH, {1:#,##0.0#} KG", PositionCordCutWasteYarn, PositionCordCutWasteYarnKG);
        ...
        public static S8x2ProductionConditionItem Create(string productCode)
        {
            var inst = new S8x2ProductionConditionItem();
        ...
        public static void Assign(S8x2ProductionConditionItemStd src, S8x2ProductionConditionItem dst)
        {
        ...
        public static NDbResult<List<S8x2ProductionConditionItem>> Gets(int? DIPPCId)
        {
            MethodBase med = MethodBase.GetCurrentMethod();

            NDbResult<List<S8x2ProductionConditionItem>> rets = new NDbResult<List<S8x2ProductionConditionItem>>();
            ...
            try
            {
                var items = cnn.Query<S8x2ProductionConditionItem>("GetS8x2ProductionConditionItems", p,
        ...
        /// Save
        /// </summary>
        /// <param name="value">The S8x2ProductionConditionItem item to save.</param>
        /// <returns></returns>
        public static NDbResult<S8x2ProductionConditionItem> Save(S8x2ProductionConditionItem value)
        {
            MethodBase med = MethodBase.GetCurrentMethod();

            NDbResult<S8x2ProductionConditionItem> ret = new NDbResult<S8x2ProductionConditionItem>();
            ...
            try
            {
                cnn.Execute("SaveS8x2ProductionConditionItem", p, commandType: CommandType.StoredProcedure);
                ret.Success(value);
        ...
        public static NDbResult<S8x2ProductionConditionItem> GetStdV(int? DIPPCId)
        {
            MethodBase med = MethodBase.GetCurrentMethod();
            ...
            try
            {
                var items = cnn.Query<S8x2ProductionConditionItem>("GetS8x2ProductionConditionItemStdVRow", p,
                    commandType: CommandType.StoredProcedure);
        ...
        public static NDbResult<S8x2ProductionConditionItem> GetStdB(int? DIPPCId)
        {
            MethodBase med = MethodBase.GetCurrentMethod();
            ...
            try
            {
                var items = cnn.Query<S8x2ProductionConditionItem>("GetS8x2ProductionConditionItemStdBRow", p,
                    commandType: CommandType.StoredProcedure);
                var data = (null != items) ? items.FirstOrDefault() : null;
                ret.Success(data);
            }
            ...
            string LotNo, int? DoffingNo)
        {
            ...
            try
            {
                var items = cnn.Query<DIPTimeTable>("SaveS8x2ProductionConditionItemStdVRow", p,
                    commandType: CommandType.StoredProcedure);
                ret.Success();
            }
            catch (Exception ex)
            ...
            string LotNo, int? DoffingNo)
        {
            ...
            try
            {
                var items = cnn.Query<DIPTimeTable>("SaveS8x2ProductionConditionItemStdBRow", p,
                    commandType: CommandType.StoredProcedure);
                ret.Success();
            }
            catch (Exception ex)
        ...
        public static NDbResult DeleteStd(int? DIPPCId)
        {
            ...
            try
            {
                var items = cnn.Query<DIPTimeTable>("DeleteS8x2ProductionConditionItemStd", p,
                    commandType: CommandType.StoredProcedure);
                ret.Success();
            }
            catch (Exception ex)
