...
{
    public class S8ProductionConditionItemStd
    {
        ...
        public static NDbResult<List<S8ProductionConditionItemStd>> Gets(string productCode)
        {
            NDbResult<List<S8ProductionConditionItemStd>> rets = new NDbResult<List<S8ProductionConditionItemStd>>();
            ...
            try
            {
                var items = cnn.Query<S8ProductionConditionItemStd>("GetS8ProductionConditionItemStd", p,
        ...
        /// <returns></returns>
        public static NDbResult<S8ProductionConditionItemStd> Save(S8ProductionConditionItemStd value)
        {
            MethodBase med = MethodBase.GetCurrentMethod();

            NDbResult<S8ProductionConditionItemStd> ret = new NDbResult<S8ProductionConditionItemStd>();
            ...
            try
            {
                cnn.Execute("SaveS8ProductionConditionItemStd", p, commandType: CommandType.StoredProcedure);
                ret.Success(value);
