...
{
    public class S8WetPickUpItem : NInpc
    {
            ...
            DateTime? DoffingDate, int doffNo, int TwistNo)
        {
            ...
            try
            {
                ...
                if (null != item && item.Count > 0)
                {
                    ...
                    S8WetPickUpItem prev = null;
                    S8WetPickUpItem curr = null;
        ...
        public static NDbResult<S8WetPickUpItem> GetLast(string ProductCode, string LotNo,
            int TwistNo)
        {
            MethodBase med = MethodBase.GetCurrentMethod();
            ...
            try
            {
                var item = cnn.Query<S8WetPickUpItem>("GetS8WetPickUpLastItem", p,
