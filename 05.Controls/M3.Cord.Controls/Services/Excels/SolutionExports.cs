...
namespace M3.Cord.Services.Excels
{
    ...
    {
        public static void Export(string solutionlot)
        {
            ...
            else
            {
                ...
                {
                    if (item.SolutionId == 15) // AX-09PV3 (10%)
                    {
                        lot = item;
                        break;
                    }
            ...
            try
            {
                using (var package = new ExcelPackage(outputFile))
                {
                    ...
                    if (null != ws)
                    {
                        ...
                        // Date
                        ws.Cells["I3"].Value = (lot.CreateDate.HasValue) ?
                            lot.CreateDate.Value.ToString("dd/MM/yyyy") : null;
