        ...
        public static class Application
        {
            public static class Cord
            {
                public static class Production
                {
                    ...
                    public static string Build = "1526";
                    public static DateTime LastUpdate = new DateTime(2024, 04, 23, 09, 30, 00);
                }
                ...
                public static class QA
                {
                    ...
                    public static string Version = AppConsts.Version;
                    public static string Minor = AppConsts.Minor;
                    public static string Build = "920";
                    public static DateTime LastUpdate = new DateTime(2023, 12, 12, 13, 00, 00);
                }
